...
class PersonServicesTest {
	...
	void testFindAll() {
		...
		assertNotNull(personOne.toString());
...
var personFour = people.get(4);
		...
		assertNotNull(personFour.toString());
...
var personSeven = people.get(7);
		...
		assertNotNull(personSeven.toString());
		System.out.println(personSeven.toString());
		assertNotNull(personSeven.toString().contains("Links: [</api/person/v1/1>;rel=\"self\"])"));
